...
public class App {
    ...
    public static void main(String[] args) {
        ...
        viewer.open(publicReport, student);   // PUBLIC — allowed for everyone
        System.out.println();

        viewer.open(facultyReport, student);  // FACULTY — denied for STUDENT
        System.out.println();

        viewer.open(facultyReport, faculty);  // FACULTY — allowed; first real load
        System.out.println();

        viewer.open(adminReport, admin);      // ADMIN — allowed; first real load
        System.out.println();

        viewer.open(adminReport, admin);      // ADMIN — allowed; cached, no reload
    }
}
